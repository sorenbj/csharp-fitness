<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateAdmin.aspx.cs" Inherits="HandIn3CS.UpdateAdmin" Theme="ThemeMyFitness" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <p class="toptext">Update administrator user profile</p>
        <br />
        <table class="myTable">
            <tr>
